...
//卡,可能也会出错,出错就请降低时钟
#define SDIO_INIT_CLK_DIV        0x76 		//SDIO初始化频率，最大400Khz 
...
typedef enum
{
	...
	SD_ERROR                           = (9),  
	//特殊错误定义 
	SD_CMD_CRC_FAIL                    = (10), /*!< Command response received (but CRC check failed) */
	SD_DATA_CRC_FAIL                   = (11), /*!< Data bock sent/received (CRC check Failed) */
	SD_CMD_RSP_TIMEOUT                 = (12), /*!< Command response timeout */
	SD_DATA_TIMEOUT                    = (13), /*!< Data time out */
	SD_TX_UNDERRUN                     = (14), /*!< Transmit FIFO under-run */
	SD_RX_OVERRUN                      = (15), /*!< Receive FIFO over-run */
	SD_START_BIT_ERR                   = (16), /*!< Start bit not detected on all data signals in widE bus mode */
	SD_CMD_OUT_OF_RANGE                = (17), /*!< CMD's argument was out of range.*/
	...
	SD_BAD_ERASE_PARAM                 = (21), /*!< An Invalid selection for erase groups */
	SD_WRITE_PROT_VIOLATION            = (22), /*!< Attempt to program a write protect block */
	SD_LOCK_UNLOCK_FAILED              = (23), /*!< Sequence or password error has been detected in unlock command or if there was an attempt to access a locked card */
	SD_COM_CRC_FAILED                  = (24), /*!< CRC check of the previous command failed */
	SD_ILLEGAL_CMD                     = (25), /*!< Command is not legal for the card state */
	SD_CARD_ECC_FAILED                 = (26), /*!< Card internal ECC was applied but failed to correct the data */
	...
	SD_CID_CSD_OVERWRITE               = (31), /*!< CID/CSD overwrite error */
	SD_WP_ERASE_SKIP                   = (32), /*!< only partial address space was erased */
	SD_CARD_ECC_DISABLED               = (33), /*!< Command has been executed without using internal ECC */
	SD_ERASE_RESET                     = (34), /*!< Erase sequence was cleared before executing because an out of erase sequence command was received */
	SD_AKE_SEQ_ERROR                   = (35), /*!< Error in sequence of authentication. */
